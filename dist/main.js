...
(function() {
  ...
  exports.init = function(context) {
    ...
    return exports.player.init();
  };

  exports.run = function(input) {
    if ((input.eachPlayStartCallback != null)) {
      input.eachPlayStartCallback(input.position);
    }
    return exports.player.run(input.points, core.context, input.position, input.blockSize);
  };
...
(function() {
  var restartEverything, restartPlayback, _;
        ...
        args = {
          points: state.units.map(function(unit) {
            return {
              position: unit.x,
              val: unit.y,
              waveData: _.find(area.state.waveforms, function(waveform) {
                return waveform.name === unit.waveName;
              }).points
            };
          }),
          bpm: state.bpm,
